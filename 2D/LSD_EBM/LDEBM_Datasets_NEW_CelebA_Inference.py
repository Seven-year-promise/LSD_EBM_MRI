...
### Parameters ###
seed_all = 798234
dataset = "CelebA64"     # MNIST, CIFAR10, CelebA64, CelebA128
...
eval_every    = 4       # Validation evaluation every ... epochs (None = never)
...
if dataset == "MNIST":
    ...
    train_dataset = torchvision.datasets.CelebA(main_path, split='train', download=True,
                                                    transform=transforms.Compose([
                                                        transforms.Lambda(crop),
                                                        transforms.Resize(64),
                                                        transforms.ToTensor(),
                                                        transforms.Normalize((0.), (1.))]))
    test_dataset = torchvision.datasets.CelebA(main_path, split='valid', download=True,
                                                    transform=transforms.Compose([
                                                        transforms.Lambda(crop),
                                                        transforms.Resize(64),
                                                        transforms.ToTensor(),
