...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='celeba64', choices=['celeba64', 'celeba', 'celeba_crop', 'celeba32_sri', 'celeba64_sri', 'celeba64_sri_crop'])
...
def get_dataset(args):
    ...
    if args.dataset == 'celeba64':
        ...
        ds_train = torchvision.datasets.CelebA(fs_prefix + 'data/{}'.format(args.dataset), download=True, split='train',
        ...
        ds_val = torchvision.datasets.CelebA(fs_prefix + 'data/{}'.format(args.dataset), download=True, split='valid',
                                             transform=transforms.Compose([
                                             transforms.Lambda(crop),
                                             transforms.Resize(args.img_size),
                                             transforms.ToTensor(),
...
class _netG(nn.Module):
    def __init__(self, args):
        ...
        self.gen = nn.Sequential(
            ...
            nn.ConvTranspose2d(args.ngf, args.nc, 4, 2, 1),
            nn.Tanh()
        )
