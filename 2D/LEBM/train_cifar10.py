...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='cifar10', choices=['cifar10', 'celeba', 'celeba_crop', 'celeba32_sri', 'celeba64_sri', 'celeba64_sri_crop'])
...
def get_dataset(args):
    ...
    if args.dataset == 'cifar10':
        import torchvision.transforms as transforms
        ds_train = torchvision.datasets.CIFAR10(fs_prefix + 'data/{}'.format(args.dataset), download=True, train=True,
                                             transform=transforms.Compose([
                                             transforms.Resize(args.img_size),
                                             transforms.ToTensor(),
                                             transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5)),
                               ]))
        ds_val = torchvision.datasets.CIFAR10(fs_prefix + 'data/{}'.format(args.dataset), download=True, train=False,
                                             transform=transforms.Compose([
                                             transforms.Resize(args.img_size),
                                             transforms.ToTensor(),
                                             transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5)),
