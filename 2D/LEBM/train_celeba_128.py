...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='svhn', choices=['svhn', 'celeba', 'celeba_crop', 'celeba32_sri', 'celeba64_sri', 'celeba64_sri_crop', 'celeba128'])
    ...
    parser.add_argument('--n_printout', type=int, default=5, help='printout each n iterations')
