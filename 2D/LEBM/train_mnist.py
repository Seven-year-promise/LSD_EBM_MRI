...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='mnist', choices=['mnist', 'celeba', 'celeba_crop', 'celeba32_sri', 'celeba64_sri', 'celeba64_sri_crop'])
...
def get_dataset(args):
    ...
    if args.dataset == 'mnist':
        import torchvision.transforms as transforms
        ds_train = torchvision.datasets.MNIST(fs_prefix + 'data/{}'.format(args.dataset), download=True, train=True,
